...
mywidgets = ['currentlayout', 'chord','decor', 'mpd2', 'decor', 'groupbox', 'windowname', 'decor', 'volume_icon', 'volume', 'decor', 'wlan_icon', 'wlan', 'net_fold', 'decor', 'weather', 'decor', 'clock', 'decor', 'battery']
